...
def get_neighbors(parameters):
    ...
    logMessage = parameters[0]  + ', ' + str(int(float(parameters[0]))) + ', ' + encodedNumber + ': '
    ...
    for i in range(len(encodedNumber)):
        ...
        for n in n_s[c]:
            ...
            logMessage = logMessage + tmpStr + ' -> ' + str(neighbor[0]) + ', '
...
if __name__ == '__main__':
    ...
    #print get_neighbors([444224224422422])
    #print encode(768512345, 10)
    #print decode('768512345', 10)
