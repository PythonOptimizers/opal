...
\begin{itemize}
\item The Optimization of Algorithmic parameters framework can be analyzed as either a processing data system or black-box optimization problem solving.
\item We can decompose any data processing to the elementary things by Data-Operator principle
...
\section{Analyse solving process by Data-Operator principle}
...
\section{Parameter Optimization is Data processing}
\begin{figure}[htpb]
  \centering
  \begin{tikzpicture}[node distance = 2cm, auto]
    % Place nodes
