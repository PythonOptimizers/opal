...
params = [param for param in DFO.parameters if param.name in ['DELMIN','CNSTOL','DELTA']]
...
NOMAD.set_parameter(name='INITIAL_MESH_SIZE',value='(1e-5 1e-4 1)')


blackbox.solve(solver=NOMAD) #,surrogate=surrogate)
